...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://staging.fixmystreet.com/";
    public static String WEBAPP_HOST = "staging.fixmystreet.com"; // used for checking Intent-URLs
    ...
    public static String USER_AGENT_POSTFIX = "FixMyStreetPWA"; // useful for identifying traffic, e.g. in Google Analytics
